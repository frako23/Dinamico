        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
          <Card>
            <CardContent className="p-4">
              ...
              <div className={cn("text-2xl font-semibold", summary.balance >= 0 ? "text-emerald-700" : "text-red-600")}>
          ...
          <Card>
            <CardContent className="p-4">
              ...
              <div className="text-2xl font-semibold text-emerald-700">{formatCurrency(summary.income, currency)}</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-4">
              <div className="text-xs text-muted-foreground">Gastos</div>
              <div className="text-2xl font-semibold text-red-600">{formatCurrency(summary.expense, currency)}</div>
            </CardContent>
          </Card>
        </div>
      </section>
